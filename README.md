...
### 📝 Rédactrice de Contenu Web — *Nasnie* (janv. 2021 – nov. 2022)
- Rédaction de fiches produits e-commerce avec descriptions techniques détaillées
- Application des bonnes pratiques SEO : mots-clés, balises Hn, maillage interne, balises méta
...
### 📞 Superviseure Téléopérateurs (Team Leader) — *mCreat pour Orange Madagascar* (févr. 2012 – déc. 2015)
- Encadrement et formation d'une équipe de 20 téléopérateurs
- Pilotage des indicateurs clés : qualité des appels, volume de ventes, taux de transformation
- Analyse des données commerciales et mise en place d'actions correctives
